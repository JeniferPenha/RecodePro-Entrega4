	...
	<div class="row">
		<div class="cold-md-7">
			...
			<form action="ClienteUpdate" method="POST">
					<input value="${cliente.idCliente}" name="id" type="number" style="visibility:hidden">
					<div class="form-floating mb-3">
						<input value="${cliente.nomeCliente}" name="nome" maxlength="40" type="text" class="form-control" id="floatingInput1"> 
						<label>Nome completo</label>
					</div>
					<div class="form-floating mb-3">
						<input value="${cliente.cpfCliente}" name="cpf" maxlength="11" type="text" class="form-control"> 
						<label>CPF (apenas números)</label>
					</div>
					<div class="form-floating mb-3">
						<input value="${cliente.emailCliente}" name="email" type="email" class="form-control" placeholder="Email">
						<label>Email</label>
					</div>
					<div class="form-floating mb-3">
						<input value="${cliente.usuarioCliente}" name="usuario" type="text" class="form-control">
						<label>Usuario</label>
					</div>
						<div class="form-floating mb-3">
						<input value="${cliente.senhaCliente}" name="senha" type="password" class="form-control">
						<label>Senha</label>
					</div>
